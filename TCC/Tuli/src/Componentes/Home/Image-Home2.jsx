export default function ImageHome2(){
    return(
        ...
        <div className="flex justify-center mb-28 max-desktop8:hidden">
            ...
            <div className="flex flex-col ml-[70px] p-14 w-[30rem] max-desktop3:ml-[50px] max-desktop3:-mt-10 max-desktop8:py-10 max-desktop8:justify-center max-desktop8:mt-2 max-desktop12:w-[55rem] max-desktop12:mt-14 max-desktop1.1:ml-[70px] max-desktop1.1:p-14 max-desktop1.1:w-[30rem] max-desktop1.1:-mt-5">
