export default function InsideContainerHome2(){
    return(
        ...
        <div className="flex flex-col justify-between ml-10 max-desktop5:flex-row max-desktop5:mt-5 max-desktop5:w-[40rem] max-desktop5:ml-[12rem] max-desktop6:ml-[5rem]">
            <div className="w-[320px] rounded-[1.4rem] shadow-Card max-desktop5:w-[300px] max-desktop5:h-[200px] max-desktop6:w-[220px] max-desktop6:h-[150px]">
            ...
            <div className="flex h-[140px] w-[320px] rounded-[1.4rem] shadow-Card max-desktop5:w-[300px] max-desktop5:h-[200px] max-desktop6:w-[210px] max-desktop6:h-[150px]">
                <div className="flex justify-start w-full max-desktop5:w-0">
