export default function InsideContainerHome2(){
    return(
        <>
        <div className="w-[350px] h-[450px] rounded-3xl shadow-Card max-desktop5:w-[300px] max-desktop5:h-[200px]">
        ...
        <div className="flex flex-col justify-between ml-10 max-desktop5:flex-row max-desktop5:-mr-3 max-desktop5:-ml-[9rem]">
        ...
        <div className="flex flex-col justify-between ml-10 max-desktop5:flex-row max-desktop5:mt-5 max-desktop5:w-[40rem] max-desktop5:ml-[12rem]">
            <div className="w-[320px] rounded-[1.4rem] shadow-Card max-desktop5:w-[300px] max-desktop5:h-[200px]">
