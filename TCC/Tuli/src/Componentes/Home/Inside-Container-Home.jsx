export default function InsideContainerHome(){
    return(
        ...
        <div className="mt-5 max-desktop7.1:mt-0">
            <div className="bg-fundo2 h-32 w-32 rounded-full absolute max-desktop8:h-24 max-desktop8:w-24 max-desktop7.1:ml-2"></div>
        ...
        <div className="mt-5 max-desktop7.1:mt-0">
            <div className="bg-fundo2 h-32 w-32 rounded-full absolute max-desktop8:h-24 max-desktop8:w-24"></div>
            <img className="relative mt-3 ml-[6rem] max-desktop6.1:w-20 max-desktop7.1:ml-[5rem]" src={"/servicos.svg"}/>
