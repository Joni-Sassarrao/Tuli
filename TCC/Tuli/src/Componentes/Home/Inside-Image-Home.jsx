export default function InsideImageHome(){
    return(
        ...
        <div className="text-texto1 py-14 px-8 -mt-10 desktop8:hidden">
            <h2 className="text-2xl font-prompt mt-12 mb-5">Bem-vindo à Tuli</h2>
            <h1 className="text-5xl font-nunito font-bold mb-5 w-[30rem]">A BELEZA QUE VOCÊ DESEJA, COM A SEGURANÇA QUE VOCÊ MERECE.</h1>
            <p className="text-xl font-prompt w-[30rem]">Transforme sua Beleza com Confiança e Praticidade.</p>
        </div>
            <img className="desktop8:hidden " src={"/Tuli2.svg"}/>
        <div>
        </div>
        </>
    )
