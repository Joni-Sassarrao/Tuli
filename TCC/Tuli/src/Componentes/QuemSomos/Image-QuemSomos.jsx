    ...
    return(
        ...
        <div className="relative flex -mb-20 bg-gradient-to-r from-texto2 bg-fundo3 max-desktop11:h-[270px]">
            <div className="flex mt-2 max-desktop8:mb-5 max-desktop9:mb-10">
                ...
                <div className="grid grid-cols-1 justify-items-end w-screen pr-10 max-desktop5:-mt-10 max-desktop8:-mt-14 max-desktop9:justify-items-start max-desktop9:px-5 max-desktop12:-mt-10">
