...
export default function Home(){
    return(
        ...
        <h1 className="flex justify-center font-nunito font-semibold text-texto2 text-6xl mt-36 mb-20 max-desktop5:text-5xl max-desktop6:text-4xl">Nossos serviços especializados incluem:</h1>
        <ContainerHome2>
