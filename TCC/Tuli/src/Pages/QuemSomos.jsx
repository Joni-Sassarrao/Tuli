...
export default function QuemSomos(){
    return(
        ...
        <div className="relative h-64 bg-gradient-to-r from-[69%] from-fundo1 to-white top-[70rem] max-desktop5:top-[48rem] max-desktop8:top-[35rem] max-desktop8:h-44 max-desktop9:top-[30rem] max-desktop9:h-28 max-desktop11:h-20 max-desktop1.1:top-[60rem] max-desktop12:top-[75rem]"></div>
        <ImageQuemSomos2/>
